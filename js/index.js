...
function Open() {
  $("#sideBarContent").animate({ width: "toggle" }, 1000);
  $("#btn-xmark").toggleClass("d-none");
  $("#btn-bars").toggleClass("d-none");

  //--------------------------
  $("#search").removeClass("animate__backOutUp");
  $("#search").addClass("animate__backInDown");
  $("#cate").removeClass("animate__backOutUp");
  $("#cate").addClass("animate__backInDown");
  $("#area").removeClass("animate__backOutLeft");
  $("#area").addClass("animate__backInLeft");
  $("#Ingredients").removeClass("animate__backOutDown");
  $("#Ingredients").addClass("animate__backInUp");
  $("#contactUs").removeClass("animate__backOutDown");
  $("#contactUs").addClass("animate__backInUp");
}
function Close() {
  $("#sideBarContent").animate({ width: "toggle" }, 1000);
  $("#btn-bars").toggleClass("d-none");
  $("#btn-xmark").toggleClass("d-none");
  //--------------------------
  $("#search").addClass("animate__backOutUp");
  $("#search").removeClass("animate__backInDown");
  $("#cate").addClass("animate__backOutUp");
  $("#cate").removeClass("animate__backInDown");
  $("#area").addClass("animate__backOutLeft");
  $("#area").removeClass("animate__backInLeft");
  $("#Ingredients").addClass("animate__backOutDown");
  $("#Ingredients").removeClass("animate__backInUp");
  $("#contactUs").addClass("animate__backOutDown");
  $("#contactUs").removeClass("animate__backInUp");
}
...
function search() {
  ...
  <div class="row py-4 ">
      <div class="col-12 col-sm-12 col-md-6 inputSearch mb-4">
          <input id="inputsearchbyname"  oninput="searchByName(this.value)" class="form-control w-100 bg-transparent text-white" type="text" placeholder="Search By Name">
      </div>
      <div class="col-12 col-sm-12 col-md-6 inputSearch mb-4">
          <input id="inputsearchbyletter" oninput="searchByFLetter(this.value)" maxlength="1" class="form-control w-100 bg-transparent text-white" type="text" placeholder="Search By First Letter">
      </div>
  </div>`;
  ...
  for (let i = 0; i < data.length; i++) {
    cartoona += `
      <div class="col-12 col-sm-12 col-md-3 col-lg-3">
        <div onclick="getMealDetails('${data[i].idMeal}')" class="meal position-relative overflow-hidden rounded-2 area-home">
    ...
    showCategories += `
        <div class="col-12 col-md-4 col-lg-3">
            <div onclick="getCategoryMeals('${
              data[i].strCategory
            }')" class="meal position-relative overflow-hidden rounded-2 area-home">
                <img class="w-100" src="${
...
function displayIngredients(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    showCategories += `
      ...
      }')" class="col-12 col-md-4 col-lg-3 area-home">
      <div class="rounded-2 text-center cursor-pointer">
...
function displayMealDetails(meal) {
  ...
  <div class="col-md-4  ">
          ...
          <div class="col-md-8">
              <h2>Instructions</h2>
              <p>${meal.strInstructions.split(" ").slice(0, 30).join(" ")}</p>
